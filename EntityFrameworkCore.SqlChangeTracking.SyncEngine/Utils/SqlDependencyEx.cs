...
namespace EntityFrameworkCore.SqlChangeTracking.SyncEngine.Utils
{
    ...
    public sealed class SqlDependencyEx : IDisposable
    {
        ...
        {
            get { return string.Format("ListenerQueue_{0}", this.Identity); }
        }

        public string ConversationServiceName
        {
            get { return string.Format("ListenerService_{0}", this.Identity); }
        }

        public string ConversationTriggerName
        {
            get { return string.Format("tr_Listener_{0}", this.Identity); }
        }

        public string InstallListenerProcedureName
        {
            get { return string.Format("sp_InstallListenerNotification_{0}", this.Identity); }
        }

        public string UninstallListenerProcedureName
        {
            get { return string.Format("sp_UninstallListenerNotification_{0}", this.Identity); }
        }
